...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        Workout.objects.create(name='Pushups', description='Upper body workout', duration=10)
        Workout.objects.create(name='Squats', description='Lower body workout', duration=15)
